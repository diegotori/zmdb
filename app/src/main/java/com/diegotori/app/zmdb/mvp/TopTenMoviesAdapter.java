...
public class TopTenMoviesAdapter extends RecyclerView.Adapter<TopTenMoviesAdapter.ViewHolder> {
    private final LayoutInflater inflater;
    private final List<MovieRankItem> movieRankItems;

    public TopTenMoviesAdapter(final Context context){
    ...
    public void setMovieRankItems(final List<MovieRankItem> newItems){
